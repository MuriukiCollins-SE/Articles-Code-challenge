...
class Article:
    def __init__(self, title, author, magazine, id=None):
        ...
        # Accept either object or ID for author
        if isinstance(author, int):
            self._author = Author.find_by_id(author)
        else:
            self._author = author

        # Accept either object or ID for magazine
        if isinstance(magazine, int):
            self._magazine = Magazine.find_by_id(magazine)
        else:
